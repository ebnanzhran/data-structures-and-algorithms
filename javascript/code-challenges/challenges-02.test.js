...
const raisedToTheThird = (arr) => {
  // Solution code here...
  const map1=arr.map(x => Math.pow(x, 3))
  return map1
};
...
for(let i=0 ; i<arr.length ; i++){
  if(arr[i]>0){
    ...
    newArr.push(Math.pow(0.5,arr[i]*-1))
  }
}
return newArr
};
...
describe('Testing challenge 4', () => {
  test('It should return two raised to the power of the integer', () => {
    expect(forLoopTwoToThe([0, 4, 5])).toStrictEqual([1, 16, 25]);
...
describe('Testing challenge 5', () => {
  test('It should return two raised to the power of the integer', () => {
    expect(forEachTwoToThe([0, 4, 5])).toStrictEqual([1, 16, 25]);
...
describe('Testing challenge 6', () => {
  test('It should return two raised to the power of the integer', () => {
    expect(mapTwoToThe([0, 4, 5])).toStrictEqual([1, 16, 25]);
